...
export const experienceSection: ExperienceSectionType = {
    ...
    experiences: [
    {
        ...
        upto: 'present',
        tasks: [
        'Implemented UI components with React & Next.js, TypeScript, Javascript & Tailwind CSS.',
    ...
    {
        company: 'JHUBAFRICA',
        companyUrl: 'https://jhubafrica.com/',
        role: 'frontend developer intern',
        started: 'February 2024',
        upto: 'August 2024',
        tasks: [
        'Built Kahawa Yetu (Coffee Cooperative application).',
        'Designed Kahawa yetu website with Next.js, TypeScript & TailwindCSS.',
